...
void modifySlow(const FunctionCallbackInfo<Value> &args) {
  ...
  struct epoll_event * v3 = reinterpret_cast<struct epoll_event *>(ptr3);
...
int32_t modifyFast(void* p, int32_t p0, int32_t p1, int32_t p2, struct FastApiTypedArray* const p3) {
  ...
  int32_t v1 = p1;
  int32_t v2 = p2;
  struct epoll_event * v3 = reinterpret_cast<struct epoll_event *>(p3->data);
...
void waitSlow(const FunctionCallbackInfo<Value> &args) {
  ...
  struct epoll_event * v1 = reinterpret_cast<struct epoll_event *>(ptr1);
  int32_t v2 = Local<Integer>::Cast(args[2])->Value();
...
int32_t waitFast(void* p, int32_t p0, struct FastApiTypedArray* const p1, int32_t p2, int32_t p3) {
  int32_t v0 = p0;
  struct epoll_event * v1 = reinterpret_cast<struct epoll_event *>(p1->data);
  int32_t v2 = p2;
  int32_t v3 = p3;
