...
const { foo } = spin.load('foo')

const handle = dlopen('module/foo/foo.so', 1)
assert(handle)
...
//run('foo.noop', foo.noop, 400000000, 10)
...
/*
try {
  run('strnlen2', () => assert(strnlen2(hello, 1024) === 5), 400000000, 10)
} catch (err) {
  console.log(err.stack)
  console.log(strnlen2(hello, 1024))
}
*/
