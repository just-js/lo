...
if (globalThis.lo) {
  if (lo.core.os === 'mac') {
    include_paths.push('/opt/homebrew/opt/openssl@3.0/include')
    lib_paths.push('/opt/homebrew/opt/openssl@3.0/lib')
    // add these if we want to statically link libssl into the shared library
    obj.push('/opt/homebrew/opt/openssl@3.0/lib/libssl.a')
    obj.push('/opt/homebrew/opt/openssl@3.0/lib/libcrypto.a')
