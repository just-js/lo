const api = {
  ...
  utf8_length_from_utf16: {
    parameters: ['pointer', 'u32'],
    pointers: ['const char16_t*'],
    result: 'u32',
    name: 'simdutf::utf8_length_from_utf16'
  },
  validate_ascii: {
    parameters: ['string', 'u32'],
    pointers: ['const char*'],
    result: 'u32',
    name: 'simdutf::validate_ascii'
  },
  validate_utf16: {
    parameters: ['pointer', 'u32'],
    pointers: ['const char16_t*'],
    result: 'u32',
    name: 'simdutf::validate_utf16'
  },
  latin1_to_utf8_safe: {
    parameters: ['string', 'u32', 'pointer', 'u32'],
    pointers: ['const char*', , 'char*'],
    result: 'u32',
    name: 'simdutf::convert_latin1_to_utf8_safe'
  },
  latin1_to_utf8: {
    parameters: ['pointer', 'u32', 'pointer'],
    pointers: ['const char*', , 'char*'],
    result: 'u32',
    name: 'simdutf::convert_latin1_to_utf8'
  },
  utf16_to_utf8: {
    parameters: ['pointer', 'u32', 'pointer'],
    pointers: ['const char16_t*', , 'char*'],
    result: 'u32',
    name: 'simdutf::convert_utf16_to_utf8'
  },
  to_well_formed_utf16: {
    parameters: ['pointer', 'u32', 'pointer'],
    pointers: ['const char16_t*', , 'char16_t*'],
    result: 'void',
    name: 'simdutf::to_well_formed_utf16'
  }
}
