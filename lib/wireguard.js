...
class AllowedIP {
  ...
  set address4 (ip) {
    this.view.setUint32(2, inet_aton(ip))
  }

  set cidr (v) {
    this.view.setUint8(18, v)
  }

  set next (ptr) {
    this.view.setBigUint64(19, BigInt(ptr), true)
  }
}
...
wireguard.list = spin.wrap(handle, wireguard.list, 0)
