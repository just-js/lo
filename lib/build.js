...
let defaultOpts = {
  v8_cleanup: 0, v8_threads: 2, on_exit: 0,
  v8flags: '--stack-trace-limit=10 --use-strict --turbo-fast-api-calls --no-freeze-flags-after-init v8_typed_array_max_size_in_heap=256 --cppgc-young-generation',
  prefix: PREFIX
}
// todo: clean this up
let c_compiler = 'gcc'
...
const CFLAGS = (getenv('CFLAGS') || `-fPIC -std=c++20 -c -fomit-frame-pointer -fno-rtti -fno-exceptions -DV8_TYPED_ARRAY_MAX_SIZE_IN_HEAP=256 -DV8_ALLOCATION_FOLDING -DV8_SHORT_BUILTIN_CALLS`).split(' ')
