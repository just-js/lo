...
const CFLAGS = (getenv('CFLAGS') || `-fPIC -std=c++20 -c -fomit-frame-pointer -fno-rtti -fno-exceptions -DV8_TYPED_ARRAY_MAX_SIZE_IN_HEAP=64 -DV8_ALLOCATION_FOLDING -DV8_SHORT_BUILTIN_CALLS${MUSL ? ' -D_LARGEFILE64_SOURCE' : ''}`).split(' ')
