const api = {
  ...
  open2: {
    ...
    parameters: ['string', 'pointer', 'i32', 'pointer'],
    pointers: ['const char*', 'sqlite3 **', , 'const char*'],
    result: 'i32'
  },
  exec: {
    name: 'sqlite3_exec',
    parameters: ['pointer', 'string', 'pointer', 'pointer', 'pointer'],
    pointers: ['sqlite3*', 'const char*', 'exec_callback',, 'char**'],
    result: 'i32'
  },
  exec2: {
    name: 'sqlite3_exec',
  ...
  prepare2: {
    ...
    parameters: ['pointer', 'string', 'i32', 'pointer', 'pointer'],
  ...
  bind_blob: {
    ...
    parameters: ['pointer', 'i32', 'pointer', 'i32', 'u64'],
    casts: [, , , , '(sqlite3_destructor_type)'],
  ...
  blob_open: {
    ...
    parameters: ['pointer', 'string', 'string', 'string', 'i64', 'i32', 'pointer'],
  ...
  serialize: {
    ...
    parameters: ['pointer', 'string', 'pointer', 'u32'],
  ...
  deserialize: {
    ...
    parameters: ['pointer', 'string', 'pointer', 'u32', 'u32', 'u32'],
  ...
  wal_hook: {
    ...
    pointers: ['sqlite3*', 'wal_callback'],
    result: 'pointer'
  },
  checkpoint: {
    name: 'sqlite3_wal_checkpoint_v2',
    parameters: ['pointer', 'string', 'i32', 'pointer', 'pointer'],
    pointers: ['sqlite3*', , , 'int*', 'int*'],
    result: 'i32'
  },
}
...
const name = 'sqlite'
const preamble = `typedef int (*exec_callback)(void*,int,char**,char**);
typedef int (*wal_callback)(void *,sqlite3*,const char*,int);
`
//const obj = []
//const libs = ['sqlite3']
const libs = []
