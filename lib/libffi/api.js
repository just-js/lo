...
if (globalThis.lo && lo.core.os === 'mac') {
  include_paths.push('/usr/local/opt/libffi/include')
  lib_paths.push('/usr/local/opt/libffi/lib')
}

export { api, includes, name, preamble, libs, obj, include_paths }
