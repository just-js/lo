...
// file descriptor operations
  ...
  // `override` exercise -- same shapes as the real lib/core's own
  // write_string/strnlen_str (E.9/later-session work), a trailing
  // length auto-derived from a preceding string via strlen().
  write_string: {
