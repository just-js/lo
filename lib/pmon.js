...
const {
  ...
  O_CLOEXEC, write, STDIN, STDOUT, STDERR, chdir,
  getaffinity, setaffinity, struct_cpu_set_t_size, kill, SIGTERM,
  _SC_CLK_TCK
} = core
//const { sysconf, _SC_NPROCESSORS_ONLN } = system
...
const cpu32 = new Uint32Array(cpu_set.buffer, 0, 4)
