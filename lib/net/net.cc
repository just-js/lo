...
void Init(Isolate* isolate, Local<ObjectTemplate> target) {
  ...
  SET_VALUE(isolate, module, "EINPROGRESS", Integer::New(isolate, (int32_t)EINPROGRESS));
  SET_VALUE(isolate, module, "EAGAIN", Integer::New(isolate, (int32_t)EAGAIN));
  SET_VALUE(isolate, module, "AF_INET", Integer::New(isolate, (int32_t)AF_INET));
  SET_VALUE(isolate, module, "SOCK_STREAM", Integer::New(isolate, (int32_t)SOCK_STREAM));
  SET_VALUE(isolate, module, "SOL_SOCKET", Integer::New(isolate, (int32_t)SOL_SOCKET));
  SET_VALUE(isolate, module, "SO_REUSEPORT", Integer::New(isolate, (int32_t)SO_REUSEPORT));
  SET_VALUE(isolate, module, "SOMAXCONN", Integer::New(isolate, (int32_t)SOMAXCONN));
  SET_VALUE(isolate, module, "MSG_NOSIGNAL", Integer::New(isolate, (int32_t)MSG_NOSIGNAL));
  SET_VALUE(isolate, module, "SOCK_DGRAM", Integer::New(isolate, (int32_t)SOCK_DGRAM));
  SET_VALUE(isolate, module, "SOCK_RAW", Integer::New(isolate, (int32_t)SOCK_RAW));
  SET_VALUE(isolate, module, "SIOCGIFADDR", Integer::New(isolate, (int32_t)SIOCGIFADDR));
  SET_VALUE(isolate, module, "IPPROTO_RAW", Integer::New(isolate, (int32_t)IPPROTO_RAW));
  SET_VALUE(isolate, module, "SIOCSIFFLAGS", Integer::New(isolate, (int32_t)SIOCSIFFLAGS));
  SET_VALUE(isolate, module, "SIOCSIFADDR", Integer::New(isolate, (int32_t)SIOCSIFADDR));
  SET_VALUE(isolate, module, "SIOCSIFNETMASK", Integer::New(isolate, (int32_t)SIOCSIFNETMASK));
  SET_VALUE(isolate, module, "SOCK_NONBLOCK", Integer::New(isolate, (int32_t)SOCK_NONBLOCK));
  SET_VALUE(isolate, module, "SOCKADDR_LEN", Number::New(isolate, (int64_t)16));
  SET_VALUE(isolate, module, "SOCK_CLOEXEC", Integer::New(isolate, (int32_t)SOCK_CLOEXEC));
  SET_VALUE(isolate, module, "PF_PACKET", Integer::New(isolate, (int32_t)PF_PACKET));
  SET_VALUE(isolate, module, "ETH_P_ALL", Integer::New(isolate, (int32_t)ETH_P_ALL));
  SET_VALUE(isolate, module, "ETH_P_ARP", Integer::New(isolate, (int32_t)ETH_P_ARP));
  SET_VALUE(isolate, module, "SIOCGIFHWADDR", Integer::New(isolate, (int32_t)SIOCGIFHWADDR));
  SET_VALUE(isolate, module, "SIOCGIFINDEX", Integer::New(isolate, (int32_t)SIOCGIFINDEX));
  SET_VALUE(isolate, module, "IFF_TUN", Integer::New(isolate, (int32_t)IFF_TUN));
  SET_VALUE(isolate, module, "IFF_TAP", Integer::New(isolate, (int32_t)IFF_TAP));
  SET_VALUE(isolate, module, "IFF_NO_PI", Integer::New(isolate, (int32_t)IFF_NO_PI));
  SET_VALUE(isolate, module, "IFF_UP", Integer::New(isolate, (int32_t)IFF_UP));
  SET_VALUE(isolate, module, "TUNSETIFF", Integer::New(isolate, (int32_t)TUNSETIFF));
  SET_VALUE(isolate, module, "TUNSETPERSIST", Integer::New(isolate, (int32_t)TUNSETPERSIST));
