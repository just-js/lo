...
//    override: [, , { param: 1, fastfield: '->length', slowfield: '.length()' }],
  ...
  getsockopt: {
    parameters: ['i32', 'i32', 'i32', 'u32array', 'u32array'],
    pointers: [, , , , 'socklen_t*'],
    result: 'i32'
  },
}
...
const includes = [
  ...
  'sys/types.h',
  'unistd.h',
  // Real, direct requirement for the EAGAIN constant below -- same
  // latent gap as lib/core_abi/lib/epoll (bindings() always includes
  // <v8.h> first, masking it there transitively).
  'errno.h'
]
const name = 'net'
...
const structs = ['ip_mreq', 'sockaddr_un', 'sockaddr_in']
