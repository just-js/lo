...
// no structs (lo_abi.h has no struct equivalent by design). constants
// are supported (lo_exports_set_i32/u64/string, see initConstantAbi
// below -- E.9). Throws clearly at generation time for anything still
// unsupported rather than emitting code that won't compile or would
// misbehave -- widen this alongside lo_abi_v8.cc gaining the matching
// dispatch support, not ahead of it.
...
// This binding's own code never writes v8:: directly -- lo_abi_v8.cc is
// the only *hand-written* file allowed to; the LO_ABI_V8_BINDING(...)
// registration shim below comes from lo_abi_v8_shim.h, not authored here.
