...
fs.defaultWriteFlags = defaultWriteFlags
fs.defaultFlags = defaultFlags
fs.defaultWriteMode = defaultWriteMode

export { fs, getStat, isFile, isDir, readFile, writeFile, readFileSlice, fileType }